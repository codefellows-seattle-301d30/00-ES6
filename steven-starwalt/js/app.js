...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT (Let is block scoped so it can only be or changed within the {code} is is declared. The console log is ourside the while function so it is outside te scope.)
  console.log(viewed)
