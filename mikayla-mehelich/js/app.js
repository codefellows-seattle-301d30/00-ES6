...
function displayPics(){
  ...
  // LET allows you to declare variables that are limited in scope to the block, statement, or expression on which it is used. VAR defines a variable globally, or locally to an entire function regardless of block scope.
  console.log(viewed);
