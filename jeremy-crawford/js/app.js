...
function displayPics(){
  ...
  // In this instance, 'const' is being used to define a block-level element within the 'while' loop, and is not recognized as a valid variable through the entire function (unlike 'var', which carries its value through an entire function). Therefore, the console.log is looking for a variable that does not exist. 
  console.log(viewed);
