...
function displayPics(){
  ...
  // With `let` the variable is scoped to the while statement, not the function that the while statement is inside. Using `var` allows access to the variable anywhere in the function it was declared, but not outside of that function.
  console.log(viewed);
