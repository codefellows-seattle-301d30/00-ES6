...
function displayPics(){
  ...
  // By using `let` rando becomes a variable that is local to the displayPics function. That means the rando variable is only availble within the function, not ouside of it. If you move the console.log within the function, the error doesn't happen. The lab tells you to delete the offending line of code, however, so that has been done.
